...
urlpatterns = [
    ...
    path('get_assets_api/<str:site_name>/', views.get_assets_by_site_name, name='get_assets_by_site_name'),
    path('asset_api/', AssetCreateAPIView.as_view(), name='asset-create'),
    path('exits/', ExitCreateView.as_view(), name='exit-list-create'),
    path('exits/<str:site_name>/', ExitListView.as_view(), name='asset-list'),
    ...
    path('get_orientation_api/<str:site_name>/', GetOrientationApiView.as_view(), name='orientation_api'),
    ...
    path('preshift_api/<str:site>/', PreShiftListCreateAPIView.as_view(), name='preshift_get'),
    path('toolbox_api/', ToolBoxListCreateAPIView.as_view(), name='toolbox_api'),
    path('toolbox_api/<str:site>/', ToolBoxListCreateAPIView.as_view(), name='toolbox_get'),
    ...
    path('mycomply_api/', views.user_comply_api_view, name='mycomply_api'),
    ...
    path('get_onsite_api/<str:site_name>/', OnSiteUserListView.as_view(), name='get_onsite_api'),
